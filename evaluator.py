...
class Evaluator:
    ...
    def evaluate(self, classifier):
        ...
        if self.stdout:
            ...
            classifier
            print
            "Accuracy for Positives: %.2f%%" % accpos
            print
            "Accuracy for Negatives: %.2f%%" % accneg
            print
            "Accuracy for (Positives|Negatives): %.2f%%" % accall
            print
            "Correlation for (Positives|Negatives): %.2f%%" % corrall
            print
            "=" * 100
            print
