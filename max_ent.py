...
class MaximumEntropyClassifier(Classifier):
    ...
    def initFeatures(self):
        ...
        print
        'Training on %i lines' % len(training_sample)
        ...
        print
        'Padding feature vectors. There are %i total features' % len(self.all_features)
    ...
    def shrinkFeatureSet(self):
        ...
        print
        'Shrunk down to %i features' % len(shrunk)
    ...
    def trainClassifier(self):
        ...
        if pickled_model:
            ...
            self.initFeatures()
            print
            'Done reading in training examples'
            kargs = {
                'algorithm': 'gis',
            }
